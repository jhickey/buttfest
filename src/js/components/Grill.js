...
export default class Grill extends Component {
    ...
    renderDisconnectOverlay() {
        return (
            <div className="grill-disconnect">
                Temeperature monitor disconnected, awaitng reconnect...
            </div>
        );
    }

    renderSVG() {
        const {temperature = 0} = this.props;
        return (
                ...
                <svg width="257px" height="513px" viewBox="0 0 257 513" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g id="smoker" transform="translate(-2.000000, 0.000000)">
                        ...
                        <text id="327°-F" fontFamily="Helvetica" fontSize="52" fontWeight="normal" fill="#4D4D4D">
                            <tspan x="58" y="231">{temperature}° F</tspan>
                        </text>
    ...
    render() {
        ...
        return (
            <div>
                {connected ? '' : this.renderDisconnectOverlay()}
                {this.renderSVG()}
            </div>
        )
    }
